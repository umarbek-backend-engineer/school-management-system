...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/allteachers/": {
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "All teachers deleted successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/execs/": {
            "get": {
                "security": [
                    {
                        "Bearer// AddExecsHandler adds new executives": []
                    },
                    {
                        "Bearer": []
                    }
                ],
                "description": "Get a list of all executives\nCreate one or multiple new executives",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    ...
                    "201": {
                        "description": "Executives created successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "Executives patched successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/execs/{id}": {
            ...
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "Executive patched successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.Exec_Update_password_request"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/models.Exec_Update_password_response"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/students/": {
            ...
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "Students patched successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/teachers/": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Teacher IDs to delete",
                        "name": "ids",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "patch": {
                "security": [
                    {
                        "Bearer// PatchTeacherHandler patches a specific teacher": []
                    },
                    {
                        "Bearer": []
                    }
                ],
                "description": "Partially update multiple teachers\nPartially update a specific teacher by ID",
                "consumes": [
                    "application/json",
                    "application/json"
                ],
    ...
    "definitions": {
        ...
        "models.Exec_Update_password_request": {
            "type": "object",
            "properties": {
                "conform_password": {
                    "type": "string"
        ...
        "models.Exec_Update_password_response": {
            "type": "object",
            "properties": {
                "password_updated": {
                    "type": "boolean"
